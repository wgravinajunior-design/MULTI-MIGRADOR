...
REM ATENCAO: ao adicionar um migrador novo, inclua a pasta na lista abaixo,
REM senao ele fica de fora do pacote e nao chega nas maquinas dos clientes.
git archive --format=zip -o migradores.zip HEAD -- "ARPA SISTEMAS" "BVX" "CASA MAGALHAES" "CLOSMAQ" "COMPUFOUR" "DIGISAT G6" "DMA SISTEMAS" "EMC SOFTWARE" "EXCEL" "FUTURA" "GANSO SISTEMAS" "GDOOR" "HIPER" "HOST" "LC SISTEMAS" "LINK PRO" "PROJECT 7" "QUESTOR" "RENSOFTWARE" "TOTVS CHEF" "UNIPLUS" "VTI" "ZWEB"
